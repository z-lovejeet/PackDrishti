...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-navy-950 text-neutral-300 border-t border-navy-900 mt-auto text-xs py-10 no-print">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        
        {/* Main Two-Column Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 pb-8 border-b border-navy-900">
          
          {/* Column 1: Statutory Framework & Legal Metrology Seal */}
          <div className="space-y-4">
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-lg bg-navy-900 border border-navy-800 text-saffron-400 flex items-center justify-center shrink-0 shadow-xs">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-2xs uppercase font-mono font-bold tracking-wider px-2 py-0.5 rounded bg-saffron-950/80 text-saffron-400 border border-saffron-700/50">
                    Govt. of India
                  </span>
                </div>
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-navy-900 text-neutral-300 border border-navy-800 text-2xs font-medium">
                <FileText size={13} className="text-saffron-400" />
                Rule 6 Mandatory Declarations
              </span>
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-navy-900 text-neutral-300 border border-navy-800 text-2xs font-medium">
                <Scales size={13} className="text-saffron-400" />
          ...
          <div className="space-y-4 lg:pl-6 lg:border-l lg:border-navy-900">
            <div>
              <span className="text-2xs uppercase font-bold tracking-wider text-saffron-400 block mb-1">
              ...
              <p className="text-neutral-500 text-2xs mt-1">
                Krishi Bhawan, Dr. Rajendra Prasad Road, New Delhi - 110001
              </p>
            </div>

            <div className="bg-navy-900/60 rounded-lg p-3.5 border border-navy-800/80 space-y-2">
              <span className="text-2xs uppercase font-bold tracking-wider text-neutral-300 block">
                Statutory Redressal &amp; Support Channels
              </span>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-2xs">
                <div className="flex items-center gap-1.5 text-neutral-300">
                  <PhoneCall size={14} className="text-saffron-400 shrink-0" />
                  <span>National Consumer Helpline: <strong className="text-white">1915</strong></span>
                </div>
                <div className="flex items-center gap-1.5 text-neutral-300">
                  <Globe size={14} className="text-saffron-400 shrink-0" />
            ...
            <div className="flex items-center justify-between text-2xs text-neutral-400 pt-1">
              ...
              <span className="text-saffron-400 font-semibold font-mono">SIH-2024-LMPC</span>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-2xs text-neutral-400">
          <p>
            Developed for regulatory inspection, evidence compounding, and consumer empowerment under Smart India Hackathon 2024.
          </p>
          <p className="text-neutral-400 sm:text-right shrink-0">
