...
1. Evaluating Multimodal VLM (Google Gemini 1.5 Flash) and OCR (PaddleOCR) extraction accuracy (Character Error Rate [CER <= 5%] and Word Error Rate [WER <= 8%]) across varied packaging substrates, fonts, and print methods (rotogravure, flexography, thermal inkjet, offset lithography).
